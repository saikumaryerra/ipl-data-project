...
# plotting
def plot_best_entertainer_for_season(entertainment, average_score, boundaries_short_name, short_team_names, top_entertainer):
    plt.suptitle(top_entertainer+" is best entertaining team for "+current_season,fontweight="bold")
